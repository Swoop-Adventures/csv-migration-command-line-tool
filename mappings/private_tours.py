# activity_mapper.py
from utils import get_component_id, get_stripped, safe_float, safe_int, get_location_id, parse_html_list, get_external_id
from .location import map_region_name_to_id
import pandas as pd

def map_private_tours_component(row, template_ids, COMPONENT_ID_MAP, context=None, row_index=-1, rooms_data=None, partner_map=None, destination_override=None):
    """
    ...
    return {
        ...
        "state": "Draft",
        "tripId": get_external_id(get_stripped(row, "TripID"), destination_override or "patagonia") or "",
        ...
        "partners": [
            get_external_id(get_stripped(row, "PartnerID"), destination_override or "patagonia")
        ],
